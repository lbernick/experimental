...
func (w *wrapTektonV1alpha1) GitRepositories(namespace string) typedtektonv1alpha1.GitRepositoryInterface {
	return &wrapTektonV1alpha1GitRepositoryImpl{
...
type wrapTektonV1alpha1GitRepositoryImpl struct {
	dyn dynamic.NamespaceableResourceInterface

	namespace string
}

var _ typedtektonv1alpha1.GitRepositoryInterface = (*wrapTektonV1alpha1GitRepositoryImpl)(nil)

func (w *wrapTektonV1alpha1GitRepositoryImpl) Create(ctx context.Context, in *v1alpha1.GitRepository, opts v1.CreateOptions) (*v1alpha1.GitRepository, error) {
...
func (w *wrapTektonV1alpha1GitRepositoryImpl) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	return w.dyn.Namespace(w.namespace).Delete(ctx, name, opts)
}

func (w *wrapTektonV1alpha1GitRepositoryImpl) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	return w.dyn.Namespace(w.namespace).DeleteCollection(ctx, opts, listOpts)
}

func (w *wrapTektonV1alpha1GitRepositoryImpl) Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.GitRepository, error) {
...
func (w *wrapTektonV1alpha1GitRepositoryImpl) List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.GitRepositoryList, error) {
...
func (w *wrapTektonV1alpha1GitRepositoryImpl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GitRepository, err error) {
...
func (w *wrapTektonV1alpha1GitRepositoryImpl) Update(ctx context.Context, in *v1alpha1.GitRepository, opts v1.UpdateOptions) (*v1alpha1.GitRepository, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "tekton.dev",
		Version: "v1alpha1",
		Kind:    "GitRepository",
...
func (w *wrapTektonV1alpha1GitRepositoryImpl) UpdateStatus(ctx context.Context, in *v1alpha1.GitRepository, opts v1.UpdateOptions) (*v1alpha1.GitRepository, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "tekton.dev",
		Version: "v1alpha1",
		Kind:    "GitRepository",
...
func (w *wrapTektonV1alpha1GitRepositoryImpl) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
