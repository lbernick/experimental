...
const (
	defaultControllerAgentName = "gitrepository-controller"
	defaultFinalizerName       = "gitrepositories.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	gitrepositoryInformer := gitrepository.Get(ctx)

	lister := gitrepositoryInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.GitRepository"),
	)
